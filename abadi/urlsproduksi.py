...
urlpatterns = [
    ...
    path("load_detailspkfromartikeltambahan", viewsproduksi.load_detailspkfromartikeltambahan, name="load_detailspkfromartikeltambahan"),
    ...
    path('eksportpemusnahanbahanbaku<str:tanggalawal>/<str:tanggalakhir>',viewsproduksi.eksportpemusnahanbahanbaku,name='eksportpemusnahanbahanbaku'),
    path('eksportpemusnahanartikel<str:tanggalawal>/<str:tanggalakhir>',viewsproduksi.eksportpemusnahanartikel,name='eksportpemusnahanartikel'),
    path('eksportpemusnahanbahanbakusubkon/<str:tanggalawal>/<str:tanggalakhir>',viewsproduksi.eksportpemusnahanbahanbakusubkon,name='eksportpemusnahanbahanbakusubkon'),
    path('eksportpemusnahanproduksubkon/<str:tanggalawal>/<str:tanggalakhir>',viewsproduksi.eksportpemusnahanproduksubkon,name='eksportpemusnahanproduksubkon'),
    ...
    path("viewartikel", viewsproduksi.views_artikel, name="views_artikelproduksi"),
    path("viewdisplay", viewsproduksi.views_display, name="views_displayproduksi"),
