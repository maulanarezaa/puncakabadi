...
urlpatterns = [
    ...
    path("notif_purchasing",viewspurchasing.notif_barang_purchasing,name="notif_purchasing"),
    path("update_verif_purchasing/<str:id>",viewspurchasing.verifikasi_data,name ="update_verif_purchasing"),
    ...
    path("update_barang_masuk/<str:id>/<str:input_awal>/<str:input_terakhir>",viewspurchasing.update_barang_masuk,name ="update_barang_masuk"),
    path("delete_barang_masuk/<str:id>/<str:input_awal>/<str:input_terakhir>",viewspurchasing.delete_barang_masuk,name ="delete_barang_masuk"),

    # rekap purchasing(gudang+produksi)
    path("rekap_purchasing",viewspurchasing.rekap_purchasing,name = "rekap_purchasing"),

    path("rekap_gudang_purchasing",viewspurchasing.rekap_gudang_purchasing,name="rekap_gudang_purchasing"),
    path("rekap_produksi_purchasing",viewspurchasing.rekap_produksi_purchasing,name="rekap_produksi_purchasing"),
    # CRUD PRODUK
