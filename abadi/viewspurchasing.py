        ...
        if len(filterspk) == 0:
            ...
            if request.method == "POST":
                ...
                list_kode_art.append(
                    {"Kode_Artikel": input_nama_art, "Jumlah_Artikel": input_jumlah_art}
                )
            ...
            for item in dataspk:
                ...
                list_kode_art.append(
                    {"Kode_Artikel": art_code, "Jumlah_Artikel": jumlah_art}
                )
            ...
            for item in list_kode_art:
                ...
                try:
                    konversi_art = (
                        ...
                        .annotate(
                            kode_art=F("KodePenyusun__KodeArtikel"),
...
def kebutuhan_barang2(request):
    ...
    if len(request.GET) == 0:
        ...
        if len(filterspk) == 0:
            ...
            if len(input_nama_art) or len(input_jumlah_art) != 0:
                list_kode_art.append({input_nama_art: input_jumlah_art})
            dataspk = (
                models.DetailSPK.objects.filter(NoSPK=getspk.id)
                .annotate(kuantitas2=Sum("Jumlah"))
                .order_by()
            ...
            for item in dataspk:
                art_code = item.KodeArtikel
                jumlah_art = item.kuantitas2
                list_kode_art.append({art_code: jumlah_art})
